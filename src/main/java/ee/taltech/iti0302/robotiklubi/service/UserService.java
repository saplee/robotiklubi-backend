...
public class UserService {
    ...
    public void updateUser(String idString, UserDto userDto) {
        try {
            Optional<User> userOptional = userRepository.findById(Long.valueOf(idString));
        ...
        } catch (Exception e) {throw new InternalServerException("Could not update user (id " + userDto + ").", e);}
    }
